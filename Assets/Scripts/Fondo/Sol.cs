...
public class Sol : MonoBehaviour
{
    ...
    void Update()
    {
        if (moverSol)
        {
            ...
            float t = Mathf.Clamp01(tiempoTranscurrido / duracionTotal);
    ...
    public void IniciarMovimiento(float duracionDia, float duracionAtardecer)
    {
        duracionTotal = duracionDia + duracionAtardecer;
